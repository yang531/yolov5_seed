...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='runs/train/exp46/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='data/seed.yaml', help='*.data path')
    ...
    parser.add_argument('--name', default='se', help='save to project/name')
